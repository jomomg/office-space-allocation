...
class Dojo:
    ...
    def allocate_office_space(person_name, email, person_type):
        ...
        if not non_full_offices:
            return "There are no offices to allocate"
    ...
    def allocate_living_space(fellow_name, email):
        ...
        if not non_full_living_spaces:
            return "There are no living spaces to allocate"
    ...
    def create_new_office(self, name):
        ...
        if similar_office or similar_living_space:
            return "An office or living space '{}' already exists".format(name)
        self.model.update(new_office, "offices")
        return "An office called '{}' has been successfully created".format(new_office.name)
    ...
    def create_new_living_space(self, name):
        ...
        return "A living space called '{}' has been successfully created".format(new_living_space.name)
    ...
    def add_fellow(self, name, email, wants_accommodation=False):
        ...
        if similar:
            print("The email address provided already exists")
        else:
            self.model.update(new_fellow, "fellows")
            print("Fellow {} has been successfully added".format(new_fellow.name))
            print(self.allocate_office_space(new_fellow.name, email, person_type="fellow"))

        if wants_accommodation:
            print(self.allocate_living_space(new_fellow.name, email))
    ...
    def print_allocations(self, filename=None):
        ...
        for fellow in fellows:
            if ("L_SPACE", fellow.current_living_space) not in rooms:
                rooms[("L_SPACE", fellow.current_living_space)] = ["{} {}".format(fellow.email_address, fellow.name)]
            else:
                rooms[("L_SPACE", fellow.current_living_space)] += ["{} {}".format(fellow.email_address, fellow.name)]
